...
> 来源: https://tencentarena.com/docs/p-competition-legged_robot_competition_26/22.0.12/guidebook/dev-guide/env/
> 抓取时间: 2026-05-19
...
监控面板中包含 env 模块，表示环境指标数据，每 1 分钟采集最新结束的 episode 数据、求平均后展示。
